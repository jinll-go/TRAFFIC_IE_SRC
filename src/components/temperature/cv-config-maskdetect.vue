    ...
    <div class="main_con_temperature_container clearfix">
        <div class="main_con_top">
            <div class="fl pl10 bold">
                <label v-tr="i18n_Masks_detect"></label>
            </div>
        </div>
        <div class="main_con_mid">
            <div class="w100 pt1">
                <table width="100%" border="0" cellpadding="2" cellspacing="1">
                    <tr>
                        <td align="center" valign="top">
                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="28%" height="30" align="right"><label v-tr="i18n_enableVideoShelter"></label> :&nbsp;</td>
                                ...
                                <tr>
                                    <td width="28%" height="30" align="right"><label v-tr="i18n_Weekday"></label> :&nbsp;</td>
                                    <td width="72%" align="left">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <CVConfigSection :weekday="weekdayidx" v-model="alarmtime" type="SECTION_EIGHT" :disabled="!d.Enable"></CVConfigSection>
                        </td>
                    </tr>
        ...
        mounted() {
            Promise.all([
                ...
                this.$store.dispatch('request', {
                    ...
                    Type: 0,
                    Data: { DetectLinkType: 20, AlarmTimeType: 1 },
                    Dev: 1,
                    Ch: 1,
                }),
            ]).then((r) => {
            ...
            save() {
                ...
                Promise.all([
                    ...
                    this.$store.dispatch('request', {
                        url: 'goform/frmDetectLinkPara',
                        Type: 1,
                        Data: $.extend(true, { DetectLinkType: 20, AlarmTimeType: 1 }, this.linktype, { AlarmTime: time_sections }),
                        Dev: 1,
                        Ch: 1,
                    }),
                ]).then((r) => {
