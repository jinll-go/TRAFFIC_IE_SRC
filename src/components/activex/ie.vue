<template>
    ...
    <div class="full">
        <object :id="identity" width="100%" height="100%" type="application/x-rtspvideoplugin" v-if="plugin_installed == 2">
            <param :value="readyCb" name="onload" />

            <param :value="chan_num" name="CHNUM" v-if="type == 'PREVIEW'" />
            <param :value="identity" name="IDENTITY" />
...
<script>
    import ie from 'mixin/plugins/activex';
